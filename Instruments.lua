local instruments = {
   ...
   {"rbxassetid://5924276201", "acoustic grand piano", settings = {["Gain"] = 0, ["Offset"] = -7}, color = Color3.fromRGB(29, 43, 136)},
   {"rbxassetid://5924276201", "bright acoustic piano", settings = {["Gain"] = 0, ["Offset"] = -7}, color = Color3.fromRGB(29, 43, 136)},
   {"rbxassetid://5924276201", "electric grand piano", settings = {["Gain"] = 0, ["Offset"] = -7}, color = Color3.fromRGB(27, 137, 227)},
   {"rbxassetid://5924276201", "honky-tonk piano", settings = {["Gain"] = 0, ["Offset"] = -7}, color = Color3.fromRGB(29, 43, 136)},
   {"rbxassetid://5924276201", "electric piano 1", settings = {["Gain"] = 0, ["Offset"] = -7}, color = Color3.fromRGB(27, 137, 227)},
   {"rbxassetid://5924276201", "electric piano 2", settings = {["Gain"] = 0, ["Offset"] = -7}, color = Color3.fromRGB(27, 137, 227)},
   {"rbxassetid://109618842", "harpsichord", settings = {["Offset"] = -12}, color = Color3.fromRGB(227, 135, 27)},
   {"rbxasset://Sounds/electronicpingshort.wav", "clavinet", settings = {["Offset"] = -10}, color = Color3.fromRGB(19, 139, 161)},
   {"rbxasset://Sounds/electronicpingshort.wav", "celesta", settings = {["Offset"] = -10}, color = Color3.fromRGB(19, 139, 161)},
   {"rbxasset://Sounds/electronicpingshort.wav", "glockenspiel", settings = {["Offset"] = -10}, color = Color3.fromRGB(19, 139, 161)},
   {"rbxasset://Sounds/electronicpingshort.wav", "music box", settings = {["Offset"] = -10}, color = Color3.fromRGB(19, 139, 161)},
   {"rbxassetid://584691395", "vibraphone", settings = {["Gain"] = 0.8}, color = Color3.fromRGB(131, 23, 232)},
   ...
   {"rbxassetid://775395533", "chinese", settings = {["Offset"] = -6}}
}
